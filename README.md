...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-2zdvtxe.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-2zdvtxe.containers.anotherwebservice.com/
...
```
git clone git@github.com:BrunoVieira003/container-2zdvtxe.git
cd container-2zdvtxe
```
...
```
docker attach container-2zdvtxe
```
